...
class SharePointAPI {
	 ...
	 * @return Array
	 */
	public function readFromFolder($listName = 'Itop_Documents', $folderName = '/Itop_Documents/12708', $isLibrary = false, $limit = 1, $query = NULL, $view = NULL, $sort = NULL, $listName2 = 'Shared Documents') {
		return $this->read($listName, $limit, $query, $view, $sort, "<Folder>" . ($isLibrary ? '' : 'Lists/') . $listName2 . '/' . $folderName . "</Folder>" );
	}
